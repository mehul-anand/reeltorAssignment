          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center px-4 sm:mr-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                  Click
                </span>
                <svg
                  className="w-3 h-3"
